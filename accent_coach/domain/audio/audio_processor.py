...
Migrated from root audio_processor.py with improvements.
"""
...
class AudioProcessor:
    ...
    Handles loading, conversion, normalization.
    """
    ...
    def load_from_bytes(audio_bytes: bytes, target_sr: int = 16000) -> Tuple[Optional[np.ndarray], Optional[int]]:
        ...
        Returns:
            Tuple of (waveform, sample_rate) or (None, None) on failure
        """
        # Method 1: soundfile
        try:
            ...
            if sr != target_sr:
                waveform = AudioProcessor._resample(waveform, sr, target_sr)
...
class TTSGenerator:
    ...
    Migrated from root audio_processor.py.
    """
